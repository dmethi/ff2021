...
You can read the Week 9 Recap [here](https://houserealest.substack.com/p/week-9-recap?justPublished=true). 

You can find the season recap (thru week 4) [here]({{ site.baseurl | prepend: site.url }}/season-recap-week-4/).

## Season Review
![Week Overview](/week10/week10.png)
...
## Playoff Odds
![Playoff Odds](/week10/week10odds.png)

## Positional Points Breakdown
{% include_relative week10/stacked_bar.html %}

## Projected / Actual / Optimal Points
{% include_relative week10/horitontal_plot.html %}
...
## Luck Rating
{% include_relative week10/luck.html %}

## Player Values
{% include_relative week10/values.html %}
